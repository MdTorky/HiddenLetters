  ...
  return (
    <section className="p-6 sm:p-8 rounded-[2rem] bg-white/10 backdrop-blur-sm border-[3px] border-white/30 shadow-xl transition-all duration-300">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-sm font-bold tracking-widest text-[#dbeafe] uppercase">Input Terminal</h3>
          ...
          <div key={rowIndex} className="flex justify-center gap-2 sm:gap-3">
            {row.map((key, i) => (
              <motion.button
                ...
                className="w-10 h-10 sm:w-14 sm:h-14 flex items-center justify-center bg-white rounded-full text-xl sm:text-2xl font-extrabold text-cute-blue transition-all border-[3px] border-transparent hover:border-blue-200 shadow-[0_4px_0_rgba(0,0,0,0.15)] active:shadow-[0_0px_0_rgba(0,0,0,0.15)] cursor-grab active:cursor-grabbing"
              >
